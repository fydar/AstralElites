...
public class AsteroidHitParticles : MonoBehaviour, ISerializationCallbackReceiver
{
    private static AsteroidHitParticles instance;
    ...
    public void PlayOnAsteroid(Vector2 impactOrigin, Vector2 impactNormal, float impactPower, Asteroid asteroid)
    {
        ...
        shape.mesh = asteroid.emissionLine;
